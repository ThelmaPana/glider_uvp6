...
'''
Download data from the science project 7587, in which Appendicularia and Rhizaria were manually validated.
...
print('### Download data for sience!')
...
with ecotaxa_py_client.ApiClient(config) as client:
    ...
    proj = projects_instance.project_query(7587)
    ...
    objs = objects_instance.get_object_set(7587, filters,
...
pq.write_table(
  ...
  where='/home/tpanaiotis/Documents/These/glider_uvp6/data/08.uvp6_objects_science.parquet',
